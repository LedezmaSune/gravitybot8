...
export class ReminderService {
    async create(userId: string, chatId: string, text: string, time: string, mediaPath?: string, mediaType?: string) {
        return await createReminder(userId, chatId, text, time, mediaPath, mediaType);
    }
